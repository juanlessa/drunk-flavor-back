...
import {
  AUTH_COOKIE,
  AUTH_COOKIE_OPTIONS,
} from "@/shared/infra/fastify/constants/cookie.constants";
import type { Controller } from "@/shared/infra/fastify/types/fastify.types";
import type { AuthenticateUserReqBody } from "./authenticateUser.schema";

export const authenticateUserController: Controller = async (
  request,
  reply
) => {
